...
public class ProxyApplication extends Application {
    ...
    public void onCreate() {
        Log.e(TAG, "ProxyApplication onCreate");
        beforeOnCreate();
        super.onCreate();
    ...
    protected void attachBaseContext(Context base) {
        ...
        Log.e(TAG, "ProxyApplication attachBaseContext");
        ...
        try {
            ...
            //base.getClassLoader(); 是不是就等同于 (ClassLoader) RefInvoke.getFieldObject()? 有空验证下//?
            ...
            try {
                Object actObj = dLoader.loadClass("com.zeus.packer.source.apk.PackerSourceActivity");
