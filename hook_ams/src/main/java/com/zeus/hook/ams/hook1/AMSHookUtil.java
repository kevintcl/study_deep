package com.zeus.hook.ams.hook1;
...
public class AMSHookUtil {
    ...
    public static void hookActivity(Context context, boolean isAppCompatActivity) {
        Log.e("kevint", "hookActivity == 1111 context= " + context);
        if (context == null) {
            return;
        }
        try {
            // hook AMS
            hookAMS(context);
            Log.e("kevint", "hookActivity == 1111 = ");
            // 在 activity launch 的时候欺骗 AMS
            hookLaunchActivity(context, isAppCompatActivity);
            Log.e("kevint", "hookActivity == 2222 = ");
        } catch (Exception e) {
            Log.e("kevint", "hookActivity == 3333 = ");
            e.printStackTrace();
            Log.e("kevint", "error==" + Log.getStackTraceString(e));
        }
    }
    ...
    private static void hookLaunchActivity(Context context, boolean isAppCompatActivity) throws
        ...
        //4.2 sdk 17 java.lang.NoSuchFieldException: sCurrentActivityThread
//        sThreadLocal


        Field sCurrentActivityThreadField = activityThreadClazz.getDeclaredField("sThreadLocal");
        sCurrentActivityThreadField.setAccessible(true);
        ThreadLocal threadLocal = (ThreadLocal) sCurrentActivityThreadField.get(null);
        Object sCurrentActivityThreadObj = threadLocal.get();
...
//        Object sCurrentActivityThreadObj = sCurrentActivityThreadField.get(null);
        ...
        Log.e("kevint", "hookLaunchActivity == mh = " + mH);
    }
    ...
    public static class ActivityThreadHandlerCallBack implements Handler.Callback {
        ...
        public boolean handleMessage(Message msg) {
            Log.e("kevint", "ActivityThreadHandlerCallBack: handleMessage=msg=" + msg);
            ...
            try {
                ...
                e.printStackTrace();
                Log.e("kevint", "eer===" + Log.getStackTraceString(e));
            }
